...
fn classify(grid: &[i32], x: i32, y: i32, mode: i32) -> i32 {
    let mut score = 0;
    if x > 0 {
        if y > 0 {
            if mode == 1 {
...
fn configure(a: i32, b: i32, c: i32, d: i32, e: i32, f: i32, g: i32, h: i32, i: i32) -> i32 {
    return a + b + c + d + e + f + g + h + i + SCALE;
}

// dendro-expect: boolean_complexity
fn eligible(a: i32, b: i32, c: i32, d: i32) -> bool {
