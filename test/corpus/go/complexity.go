...
func classify(grid []int, x int, y int, mode int) int {
    score := 0
    if x > 0 {
        if y > 0 {
            if mode == 1 {
...
func configure(a int, b int, c int, d int, e int, f int, g int, h int, i int) int {
    return a + b + c + d + e + f + g + h + i + SCALE
}

// dendro-expect: boolean_complexity
func eligible(a int, b int, c int, d int) bool {
